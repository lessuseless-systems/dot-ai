---
created: 2025-11-06T23:47:38 (UTC -06:00)
...
---
## [](https://nickel-lang.org/user-manual/package-management/#merging-records)Merging records
...
**Warning**: At the time of writing, Nickel's version is 1.0. Custom merge functions are planned for a future version. They are not detailed here yet. See the associated technical document [RFC001](https://github.com/tweag/nickel/blob/c21cf280dc610821fceed4c2caafedb60ce7177c/rfcs/001-overriding.md).

The section describes the behavior and use-cases of merge, by considering the following situations:

-   [Merging records without common fields](https://nickel-lang.org/user-manual/package-management/#simple-merge-no-common-fields)
-   [Merging records with common fields](https://nickel-lang.org/user-manual/package-management/#recursive-merge-with-common-fields)
-   [Merging records with metadata](https://nickel-lang.org/user-manual/package-management/#merging-records-with-metadata)
    -   [Optional fields](https://nickel-lang.org/user-manual/package-management/#optional-fields)
    -   [Default values](https://nickel-lang.org/user-manual/package-management/#default-values)
    -   [Contracts](https://nickel-lang.org/user-manual/package-management/#contracts)
    -   [Documentation](https://nickel-lang.org/user-manual/package-management/#documentation)
    -   [Not exported](https://nickel-lang.org/user-manual/package-management/#not-exported)
-   [Recursive overriding](https://nickel-lang.org/user-manual/package-management/#recursive-overriding)

## [](https://nickel-lang.org/user-manual/package-management/#simple-merge-no-common-fields)Simple merge (no common fields)
...
### [](https://nickel-lang.org/user-manual/package-management/#specification)Specification
...
### [](https://nickel-lang.org/user-manual/package-management/#examples)Examples

#### [](https://nickel-lang.org/user-manual/package-management/#split)Split
...
#### [](https://nickel-lang.org/user-manual/package-management/#extension)Extension
...
## [](https://nickel-lang.org/user-manual/package-management/#recursive-merge-with-common-fields)Recursive merge (with common fields)
...
### [](https://nickel-lang.org/user-manual/package-management/#specification-1)Specification
...
### [](https://nickel-lang.org/user-manual/package-management/#example)Example
...
Optional fields are intended to be used in record contracts to mean that a field might be defined, but is not mandatory. An optional field initially doesn't have a definition <sup id="fnref-optional-with-value"><a href="https://nickel-lang.org/user-manual/package-management/#fn-optional-with-value">optional-with-value</a></sup>. A value is provided by applying the contract to - or merging it with - a record which defines a value for this field:
...
### [](https://nickel-lang.org/user-manual/package-management/#merge-priorities)Merge priorities
...
#### [](https://nickel-lang.org/user-manual/package-management/#default-values)Default values
...
#### [](https://nickel-lang.org/user-manual/package-management/#forcing-values)Forcing values
...
#### [](https://nickel-lang.org/user-manual/package-management/#specification-2)Specification
...
#### [](https://nickel-lang.org/user-manual/package-management/#example-1)Example
...
### [](https://nickel-lang.org/user-manual/package-management/#contracts)Contracts

_Note_: see the [correctness section](https://nickel-lang.org/user-manual/correctness) and the [contracts section](https://nickel-lang.org/user-manual/contracts) for a thorough introduction to contracts in Nickel.
...
This is only true for _contracts attached directly to record fields_ (either directly, or coming from an enclosing record contract). In particular, `{foo | Number = 1} & {foo | force = "bar"}` will fail, but `{foo = (1 | Number)} & {foo | force = "bar"}` will succeed. In the latter case, the contract is not considered to be field metadata, but a local contract check, which is not propagated by merging.

#### [](https://nickel-lang.org/user-manual/package-management/#specification-3)Specification
...
#### [](https://nickel-lang.org/user-manual/package-management/#example-2)Example
...
### [](https://nickel-lang.org/user-manual/package-management/#not-exported)Not exported
...
### [](https://nickel-lang.org/user-manual/package-management/#documentation)Documentation
...
## [](https://nickel-lang.org/user-manual/package-management/#recursive-overriding)Recursive overriding

We've seen that default values are useful to override a single field with a different value. The combo of merging, recursive records and merge priorities together provides the capability of _recursive overriding_, which is a powerful tool, and the subject of this section.
...
In this case, when we override the default value of `version`, _the fields that depend on `version` -- here, `input` -- will also be updated automatically_. This is what we mean by recursive overriding. For example, `base_config & {version = "unstable"}` will evaluate to:
...
### [](https://nickel-lang.org/user-manual/package-management/#example-3)Example
