---
created: 2025-11-06T23:47:13 (UTC -06:00)
...
---
## [](https://nickel-lang.org/user-manual/package-management/#managing-users)Managing users

In this tutorial, you will learn how to use Nickel to manage a list of users and to export it as a YAML file.

## [](https://nickel-lang.org/user-manual/package-management/#step-1-install-nickel)Step 1: Install nickel

The first step is to make Nickel available on your system. Please refer to the different installation methods documented in [Getting started](https://nickel-lang.org/getting-started/#getting-started).

## [](https://nickel-lang.org/user-manual/package-management/#step-2-think-about-the-schema)Step 2: Think about the schema
...
## [](https://nickel-lang.org/user-manual/package-management/#step-3-write-a-contract)Step 3: Write a contract
...
Please note that using a contract isn't mandatory per-se to use Nickel, but it will allow you to validate your configuration (See [Step 6](https://nickel-lang.org/user-manual/package-management/#step-6-try-to-make-a-mistake) for an example), provide in-code information thanks to the LSP, and to document your code at the same time.
...
## [](https://nickel-lang.org/user-manual/package-management/#step-4-write-users)Step 4: Write users
...
## [](https://nickel-lang.org/user-manual/package-management/#step-5-export-as-yaml)Step 5: Export as YAML
...
## [](https://nickel-lang.org/user-manual/package-management/#step-6-try-to-make-a-mistake)Step 6: Try to make a mistake
